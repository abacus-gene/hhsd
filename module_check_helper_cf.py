'''
THIS MODULE CONTAINS AN EXTENSIVE ARRAY OF FUNCTIONS THAT AIM TO CHECK FOR 
MISSPECIFICATIONS OF DATA PROVIDED IN THE CONTROL FILE, AND PARAMETERS
RELEVANT TO THE HM ALGORITHM
'''
...
from module_tree import name_internal_nodes
from module_tree import get_all_populations
