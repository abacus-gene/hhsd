'''
THIS MODULE CONTAINS THE FUNCTIONS REQUIRED TO INGEST AND CHECK THE PARAMETERS OF THE CONTROL FILE PROVIDED MY THE USER.
'''
...
from module_helper import read_filter_comments
from module_helper import read_format_curlybrackets
from module_helper import stripall
from module_helper import dict_merge
from module_helper import param_name_match

from module_check_helper_cf import check_output_dir, check_msa_file, check_imap_file, check_newick, check_imap_msa_compat, check_imap_tree_compat, check_can_infer_theta, check_mode, check_GDI_threshold, check_migration#, check_generation_threshold, check_criteria
